...
'''
Single Indicator Strategy 1
Strategy: SMA: MA_period=15
...
Strategy 1: double SMA crossing: fast=30, slow=100
Strategy 2: RSI: upper=65, lower=35
'''
class MyStrategy_MI_1(bt.Strategy):
    params = dict(
        pfast=30,  # period for the fast moving average
        pslow=100,   # period for the slow moving average
        rsi_per=14,
